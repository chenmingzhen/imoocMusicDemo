...
public class MainActivity extends BaseActivity {
    ...
    private MusicSourceModel mMusicSource;
    @Override
    ...
    private void initData(){
        ...
        mMusicSource=mRealmHelper.getMusicSource();
...
//使RecyclerView不跟随滑动
        ...
        mGridAdapter = new MusicGridAdapter(this,mMusicSource.getAlbum());
        ...
        mListAdapter = new MusicListAdapter(this, mRvList,mMusicSource.getHot());
